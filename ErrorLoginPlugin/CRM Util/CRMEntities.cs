...
namespace ErrorHandling
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<ErrorHandling.ContactState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((ErrorHandling.ContactState)(System.Enum.ToObject(typeof(ErrorHandling.ContactState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<ErrorHandling.Contact> Referencedcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntities<ErrorHandling.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_customer_contacts");
				this.SetRelatedEntities<ErrorHandling.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<ErrorHandling.Contact> Referencedcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntities<ErrorHandling.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_master_contact");
				this.SetRelatedEntities<ErrorHandling.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public ErrorHandling.Contact Referencingcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntity<ErrorHandling.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingcontact_customer_contacts");
				this.SetRelatedEntity<ErrorHandling.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public ErrorHandling.Contact Referencingcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntity<ErrorHandling.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
	}
	...
	/// </summary>
	[System.Runtime.Serialization.DataContractAttribute()]
	[Microsoft.Xrm.Sdk.Client.EntityLogicalNameAttribute("new_errorlog")]
	[System.CodeDom.Compiler.GeneratedCodeAttribute("CrmSvcUtil", "6.1.0001.0123")]
	public partial class new_errorlog : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public const string EntityLogicalName = "new_errorlog";
		...
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("new_errorlogid")]
		public System.Nullable<System.Guid> new_errorlogId
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<System.Guid>>("new_errorlogid");
			}
			set
			{
				this.OnPropertyChanging("new_errorlogId");
				this.SetAttributeValue("new_errorlogid", value);
				if (value.HasValue)
				{
					base.Id = value.Value;
				}
				...
				this.OnPropertyChanged("new_errorlogId");
			}
		}
		...
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("statecode")]
		public System.Nullable<ErrorHandling.new_errorlogState> statecode
		{
			get
			{
				Microsoft.Xrm.Sdk.OptionSetValue optionSet = this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>("statecode");
				if ((optionSet != null))
				{
					return ((ErrorHandling.new_errorlogState)(System.Enum.ToObject(typeof(ErrorHandling.new_errorlogState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		/// <summary>
		/// Reason for the status of the Error Log
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("statuscode")]
		public Microsoft.Xrm.Sdk.OptionSetValue statuscode
		{
	...
	public partial class CrmServiceContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="ErrorHandling.Contact"/> entities.
		/// </summary>
		public System.Linq.IQueryable<ErrorHandling.Contact> ContactSet
		{
			get
			{
				return this.CreateQuery<ErrorHandling.Contact>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="ErrorHandling.new_errorlog"/> entities.
		/// </summary>
		public System.Linq.IQueryable<ErrorHandling.new_errorlog> new_errorlogSet
		{
			get
			{
				return this.CreateQuery<ErrorHandling.new_errorlog>();
			}
		}
	}
}
